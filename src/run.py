...
def execute(params, gif_id=None, plot_flag=False, mat_flag=False, stat_id=None, mat_save_flag=True, plot_speed_control=False):
    ...
    if plot_flag or mat_flag:
        env_data = generate_plots(env, gif_id=gif_id, mat_flag=mat_flag, plot_flag=plot_flag, stat_id=stat_id, mat_save_flag=mat_save_flag, plot_speed_control=False)
