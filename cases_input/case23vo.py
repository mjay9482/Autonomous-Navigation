...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 00:29:32 2024
...
agent_init_state = [
    ...
    [1., 0., 0., 37.5, 21.675, -2*np.pi/3, 0., 115.5/60, 0., 0.], 
    [1., 0., 0., 12.5, 21.675, -np.pi/3, 0., 115.5/60, 0., 0.],
    [1., 0., 0., 42.675, -17.675, 3*np.pi/4, 0., 115.5/60, 0., 0.]
    ]
...
kcs2_guidance['waypoints'] = [[37.5, 21.675], [12.5, -21.675]]
kcs2_guidance['reactive_guidance'] = 'vo'

kcs3_guidance = kcs_guidance.copy()
kcs3_guidance['waypoints'] = [[12.5, 21.675], [37.5, -21.675]]
kcs3_guidance['reactive_guidance'] = 'vo'

kcs4_guidance = kcs_guidance.copy()
kcs4_guidance['waypoints'] = [[42.675, -17.675], [7.325, 17.675]]
