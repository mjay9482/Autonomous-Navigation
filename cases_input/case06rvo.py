...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 14 22:11:36 2024
...
agent_init_state = [
    ...
    [1., 0., 0., -15, 25, -np.pi/3, 0., 115.5/60, 0., 0.],
    [1., 0., 0., -20, 20, -np.pi/4, 0., 115.5/60, 0., 0.]
    ]
...
kcs1_guidance['waypoints'] = [[-30, 0], [30, 0]]
kcs1_guidance['reactive_guidance'] = 'rvo'

kcs2_guidance = kcs_guidance.copy()
kcs2_guidance['waypoints'] = [[-15, 25], [15, -25]]
