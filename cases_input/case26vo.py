...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 14:35:11 2024
...
# boundary_list = [
#     [3680, -14720, 3680, -3680, 10, 0.05],
#     [3680, -3680, 14720, -3680, 10, 0.05],
#     [14720, -3680, 14720, 3680, 10, 0.05],
#     [14720, 3680, 3680, 3680, 10, 0.05],
#     [3680, 3680, 3680, 14720, 10, 0.05],
#     [3680,14720, -3680, 14720, 10, 0.05],
#     [-3680, 14720, -3680, 3680, 10, 0.05],
#     [-3680, 3680, -14720, 3680, 10, 0.05],
#     [-14720, 3680, -14720, -3680, 10, 0.05],
#     [-14720, -3680,-3680, -3680, 10, 0.05],
...
boundary_list = [
    [2760, -14720, 2760, -2760, 5, 0.05],
    [2760, -2760, 14720, -2760, 5, 0.05],
    [14720, -2760, 14720, 2760, 5, 0.05],
    [14720, 2760, 2760, 2760, 5, 0.05],
    [2760, 2760, 2760, 14720, 5, 0.05],
    [2760, 14720, -2760, 14720, 5, 0.05],
    [-2760, 14720, -2760, 2760, 5, 0.05],
    [-2760, 2760, -14720, 2760, 5, 0.05],
    [-14720, 2760, -14720, -2760, 5, 0.05],
    [-14720, -2760,-2760, -2760, 5, 0.05],
