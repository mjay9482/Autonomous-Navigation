...
agent_init_state = [
    ...
    [1, 0., 0., -25., 50., -np.pi/2, 0., 115.5/60, 0., 0.]
    ]
...
kcs1_guidance['waypoints'] = [[50., 0.], [-25., 50.]]
kcs1_guidance['reactive_guidance'] = 'vo'

kcs2_guidance = kcs_guidance.copy()
kcs2_guidance['waypoints'] = [[-25., 50.], [50., 0.]]
...
boundary_list = [
    ...
    [14720, 7360, 0, 7360, 10, 0.005],
    [0, 7360, 0, 14720, 10, 0.005],
    [0, 14720, -14720, 14720, 10, 0.005],
    [-14720, 14720, -14720, -7360, 10, 0.005],
    [-14720, -7360, 14720, -7360, 10, 0.005]
]
