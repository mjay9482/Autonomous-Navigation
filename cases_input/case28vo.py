...
agent_init_state = [
    [1, 0., 0., 0., 50., -np.pi/2, 0., 115.5/60, 0., 0.],
    ]
...
kcs1_guidance['waypoints'] = [[0., 50.], [50., 0.]]
...
boundary_list = [
    ...
    [14720, 7360, 3680, 7360, 10, 0.005],
    [3680, 7360, 3680, 14720, 10 , 0.005],
    [3680, 14720, -3680, 14720, 10, 0.005],
    [-3680, 14720, -3680, 7360, 10, 0.005],
    [-3680, 7360, -7360, 7360, 10, 0.005],
    [-7360, 7360, -7360, -7360, 10, 0.005],
